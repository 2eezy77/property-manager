/**
 * Billing-month keys for payment history groups.
 * Use the calendar year-month on the timestamp (or DATE), not local getMonth()
 * — `2026-08-01T00:00:00.000Z` is August, not July in US timezones.
 */

function calendarMonthKey(raw) {
...
function monthGroupSummary(month) {
  if (!month) return '';
